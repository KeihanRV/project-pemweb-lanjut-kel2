        ...
        <nav class="mt-4 space-y-1">
            <a href="{{ route('dashboard') }}"
               ...
               {{ request()->routeIs('dashboard') ? 'font-semibold text-slate-800 bg-white shadow-md shadow-gray-100/70 border border-gray-50' : 'text-gray-400 hover:bg-gray-50' }}">
                <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('dashboard') ? 'text-teal-500' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('bahan-makanan') }}"
               ...
               {{ request()->routeIs('bahan-makanan') ? 'font-semibold text-slate-800 bg-white shadow-md shadow-gray-100/70 border border-gray-50' : 'text-gray-400 hover:bg-gray-50' }}">
                <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('bahan-makanan') ? 'text-teal-500' : '' }}" fill="currentColor" viewBox="0 0 20 20">
            ...
            <a href="{{ route('profile.edit') }}"
               class="flex items-center gap-3 px-4 py-3 text-sm font-medium transition-all rounded-xl
               {{ request()->routeIs('profile.edit') ? 'font-semibold text-slate-800 bg-white shadow-md shadow-gray-100/70 border border-gray-50' : 'text-gray-400 hover:bg-gray-50' }}">
                <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('profile.edit') ? 'text-teal-500' : '' }}" fill="currentColor" viewBox="0 0 20 20">
